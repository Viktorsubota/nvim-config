local function fuzzy_refine(picker)
    ...
    -- Live pickers (grep) send typed input to the finder as a new search,
    -- bypassing the fuzzy matcher entirely; refine needs the matcher

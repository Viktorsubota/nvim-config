        ...
        config = function()
            ...
            vim.api.nvim_create_autocmd("LspAttach", {
                ...
                callback = function(ev)
                    ...
                    -- 0.12 API: enable() manages refresh on buffer changes itself
                    -- (vim.lsp.codelens.refresh is deprecated, removed in 0.13)
            ...
            -- Workspace libraries (vim API types, plugin sources) are provided
            -- on demand by lazydev.nvim
            vim.lsp.config("lua_ls", {
                settings = {
                    Lua = {
                        runtime = { version = "LuaJIT" },
                        -- moved from .luarc.json, which would otherwise take
                        -- priority over settings pushed by the client
